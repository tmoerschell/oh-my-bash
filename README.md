...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/tmoerschell/oh-my-bash/custom-build/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/tmoerschell/oh-my-bash/custom-build/tools/install.sh -O -)"
```
